...
const Contact = () => {
  ...
  const sendMessage = async (event, value) => {
    ...
    //await axios.post("https://marilynart-backend.herokuapp.com/user-messages", Usermessage)
    await axios.post("http://localhost:1337/user-messages", Usermessage)
    openPopup()
    setEmail("")
    setMessage("")
  }
  ...
  return (
    <div className={styles.root}>
      ...
      <form className={styles.sendMsg}>
        ...
        />
        {isMessageError && <p style={errorTextStyle}>Kérjuk ne hagyja ezt a mezőt üresen!</p>}
