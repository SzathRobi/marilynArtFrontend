...
const Login = () => {
  ...
  const userLogin = async (e) => {
    ...
    const login = await fetch(
      "https://marilynart-backend.herokuapp.com/auth/local" /*"http://localhost:1337/auth/local"*/,
      {
        method: "POST",
        headers: {
  ...
  return (
    <div className={styles.login}>
      <Head>
        <title>MarilynArt/Bejelentkezés</title>
      </Head>
      ...
      <form>
        ...
        <div className={styles.btnContainer}>
          ...
          <p className={styles.loginRegLink}>
            <Link href="/auth/regisztracio">
              <a>Ha még nem regisztráltál itt megteheted!</a>
            </Link>
          </p>
        </div>
      </form>
